...
namespace Analyser
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var constraintsProvider = new ConstraintsProvider("./Files/BasicWW3.eaxml", ns.NamespaceName);

            var validationWriter = new ValidationWriter("./Files/BasicWW3.eaxml", ns);
